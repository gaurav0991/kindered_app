...
import 'package:kinderedecommerce/explore_page.dart';
...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  Widget build(BuildContext context) {
    final val = Provider.of<exploreProvider>(context);
    if (ct == 0) {
      val.getData();
      ct++;
    }
        ...
        val.isloading == true
            ...
            : Container(
                ...
                child: StaggeredGridView.countBuilder(
                  crossAxisCount: 4,
                  padding: EdgeInsets.all(0),
                  itemCount: val.exploreData.length,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => ExplorePage(
                                    imageUrl:
                                        val.exploreData[index].brandImage.cover,
                                  )));
                    },
                    child: Container(
                      child: ClipRRect(
